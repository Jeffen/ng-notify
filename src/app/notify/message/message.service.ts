...
import { NgMessageConfig } from './message.config';
import { NgMessageData, NgMessageDataFilled, NgMessageDataOptions } from './message.definition';
...
@Injectable()
export class NgMessageService extends NgMessageBaseService<NgMessageContainerComponent<NgMessageConfig>, NgMessageData> {
